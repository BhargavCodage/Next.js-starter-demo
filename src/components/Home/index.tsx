          ...
          <div className="mx-auto px-6 max-w-6xl text-gray-500">
            <div className="text-center">
              <h2 className="text-3xl text-gray-950 dark:text-white font-semibold">
                Seamlessly integrates with <br className="hidden sm:block" /> your
              ...
              <ul className="grid grid-cols-2 gap-2">
                <li>
                  <Link href="/blog" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">Blog</Link>
                </li>
                <li>
                  <Link href="/about" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">About Us</Link>
                </li>
              </ul>
            </div>
